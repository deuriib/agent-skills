# Web
URL: https://flet.dev/docs/publish/web/

Publishing Flet appWeb
Publish Flet web app

Flet allows publishing your app as a static or dynamic website.

Static website - content is delivered as-is and Python runs in the browser (Pyodide).

Dynamic website - content is generated per user and Python runs on the server.
