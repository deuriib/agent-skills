# OverlayImage
URL: https://flet.dev/docs/controls/map/overlayimage

ReferenceControlsMapOverlaysOverlayImage
OverlayImage
...
Properties
bounds - The latitude and longitude bounds where this image will be displayed.
Properties​
build
bounds
instance-attribute
