# RotatedBox
URL: https://flet.dev/docs/controls/rotatedbox

ReferenceControlsRotatedBox
RotatedBox

Rotates its content by an integral number of quarter turns.

Unlike LayoutControl.rotate (which uses Transform.rotate and applies the rotation only at paint time), RotatedBox applies the rotation before layout. This means the control's rotated dimensions participate in layout and can affect surrounding controls.

Inherits: LayoutControl

Properties
content - The Control to rotate.
quarter_turns - The number of clockwise quarter turns.
Example​
import flet as ft
