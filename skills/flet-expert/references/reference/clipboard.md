# Clipboard
URL: https://flet.dev/docs/services/clipboard

ReferenceServicesClipboard
Clipboard
...
Methods
get - Retrieves data from the clipboard.
get_files - Retrieves file references from the clipboard.
get_image - Retrieves image data from the clipboard.
set - Stores the given data on the clipboard.
set_files - Stores file references on the clipboard.
set_image - Stores image bytes on the clipboard.
Examples​
Text​
import flet as ft
...
str | None - The string data retrieved from the clipboard, or None if the clipboard is empty or does not contain string data.
deployed_code
get_files
async
​
...
list[str] - A list of file references available in the clipboard. On Android these are typically content URIs.

Raises:

FletUnsupportedPlatformException - If called on platforms other than the following: Android, macOS, Windows, Linux.
deployed_code
get_image
async
​
Copy
get_image() -> bytes | None

Retrieves image data from the clipboard.

Returns:

bytes | None - The image data retrieved from the clipboard as bytes, or None if the clipboard is empty or does not contain image data.
deployed_code
set
async
​
...
FletUnsupportedPlatformException - If called on platforms other than the following: macOS, Windows, Linux.
deployed_code
set_image
async
​
...
FletUnsupportedPlatformException - If called on platforms other than the following: Android, iOS, Web.
Edit this page