# BannerAd
URL: https://flet.dev/docs/controls/ads/bannerad

ReferenceControlsAdsBannerAd
BannerAd
...
FletUnsupportedPlatformException - When this control is used on a web and/or non-mobile platform.

Inherits: LayoutControl, BaseAd

Events
on_paid - Called when this ad is estimated to have earned money.
on_will_dismiss - Called before dismissing a full screen view.
Examples​
Example 1​
import flet as ft
...
Copy
on_paid: (
    ControlEventHandler[PaidAdEvent[BannerAd]] | None
) = None
...
​
Copy
on_will_dismiss: ControlEventHandler[BannerAd] | None = (
    None
)
