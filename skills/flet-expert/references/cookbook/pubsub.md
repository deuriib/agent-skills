# PubSub
URL: https://flet.dev/docs/cookbook/pub-sub
...
subscribe() to broadcast messages or subscribe_topic() on app session start.
send_all() broadcast message or send_all_on_topic() on some event, like "Send" button click.
unsubscribe() from broadcast messages or unsubscribe_topic() on some event, like "Leave" button click.
unsubscribe_all() from everything on page.on_close.
